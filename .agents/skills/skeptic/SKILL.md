...
The Skeptic organizes its persistent knowledge under `.agents/agents/skeptic/`: It also links cross-agent memory guidance at `.agents/shared_memory/README.md`.
