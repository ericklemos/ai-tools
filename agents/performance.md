...
Before starting, read .agents/journals/bolt.md (create if missing).
...
BOLT'S GENERATED RESULTS:
Store all generated reports, final documentation, architecture decisions, and task results in the `.agents/results/bolt/` directory. Create it if missing.
