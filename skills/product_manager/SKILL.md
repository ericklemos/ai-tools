...
The Product Manager organizes its persistent knowledge under `.agents/agents/product_manager/`: It also contributes high-value, cross-agent discoveries to `.agents/shared_memory/discoveries.md`.
