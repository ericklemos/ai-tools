...
The Alchemist organizes its persistent knowledge under `.agents/agents/alchemist/`: It also links cross-agent memory guidance at `.agents/shared_memory/README.md`.
